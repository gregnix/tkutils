...
proc ::sqledit::_formClear {} {
    ...
    foreach name [::tkutils::tkuform::fieldNames $F(form)] {
        # setField, NICHT set -- tkuform exportiert kein "set".
        # "::tkutils::tkuform::set" faellt erst beim Aufruf auf, nicht
        # beim Laden: invalid command name.
        ::tkutils::tkuform::setField $F(form) $name ""
    }
}
