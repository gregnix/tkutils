...
::tkutils::tkutoolbar::addButton $tb new "New"  {.msg configure -text "New clicked"}
::tkutils::tkutoolbar::addButton $tb open "Open" {.msg configure -text "Open clicked"}
::tkutils::tkutoolbar::addSeparator $tb
::tkutils::tkutoolbar::addToggle $tb wrap "Wrap" ::wrapvar
vwait forever
