...
|---|---|---|---|---|---|---|---|---|---|
| `tkutils::tkuwinico` | 0.1 | build Windows `.ico` files from Tk images: render each size from SVG (`-scaletowidth`), scale a raster photo, or pack caller-rendered images; alpha preserved | Tk · images | Y | Y | Y | tkutils | `lib/tm/tkutils/tkuwinico-0.1.tm` | tclutils::tuico |
...
| `tkutils::tkumdview` | 0.1 | Markdown viewer (headings outline + rendered preview) | Tk · widgets | Y | N | N | tkutils | `lib/tm/tkutils/tkumdview-0.1.tm` | tclutils::tumd |
...
| `tkutils::tkupdfinspect` | 0.1 | PDF structure inspector (read-only) | Tk · widgets | Y | N | N | tkutils | `lib/tm/tkutils/tkupdfinspect-0.1.tm` | tclutils::tupdf |
