...
| `tclutils::tupostgrest` | 0.1 | minimal PostgREST REST client (HTTP + JSON) | Network · clients | Y | Y | N | tclutils | `lib/tm/tclutils/tupostgrest-0.1.tm` | http,tclutils::tujson,tclutils::tuurl,tls |
