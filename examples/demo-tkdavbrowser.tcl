# Usage: tclsh demo-tkdavbrowser.tcl ?url user password?
...
package require tkutils::tkdavbrowser
package require tclutils::tudav

wm title . "tkdavbrowser demo"
set editable [expr {[llength $argv] >= 3}]
set b [::tkutils::tkdavbrowser::widget .b -editable $editable -oncollection {apply {{w info} {
...
if {[llength $argv] >= 3} {
    ...
    ::tkutils::tkdavbrowser::setClient .b $c
    ::tkutils::tkdavbrowser::refresh .b
} else {
    ::tkutils::tkdavbrowser::setData .b {
