...
wm title . "tkstatus demo"
pack [ttk::frame .body -width 360 -height 120] -fill both -expand 1
ttk::button .body.f -text "Flash 'Saved.'" -command {::tkutils::tkstatus::flash .st "Saved." 1500}
ttk::button .body.p -text "Progress 75%" -command {::tkutils::tkstatus::progress .st 75}
