#!/usr/bin/env tclsh
# tkudavaccount demo: enter DAV server details, test the connection, and -- once
...
package require tkutils::tkudavaccount
...
proc demo::client {} {
    set cfg [::tkutils::tkudavaccount::getConfig .a]
...
wm title . "tkudavaccount demo"

set a [::tkutils::tkudavaccount::widget .a -type carddav \
    -command {apply {{ok msg} {
        ...
        if {$ok} {
            ...
            set u [dict get [::tkutils::tkudavaccount::getConfig .a] user]
...
::tkutils::tkudavaccount::setConfig $a {url http://127.0.0.1:5232/ user alice password pw type carddav}
