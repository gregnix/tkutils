...
package require tkutils::tkuimage

set v [::tkutils::tkuimage::view .v]
ttk::frame .bar
ttk::button .bar.zin  -text "Zoom +" -command {::tkutils::tkuimage::zoomIn .v}
ttk::button .bar.zout -text "Zoom -" -command {::tkutils::tkuimage::zoomOut .v}
ttk::button .bar.z1   -text "1:1"    -command {::tkutils::tkuimage::zoom1 .v}
ttk::button .bar.fit  -text "Fit"    -command {::tkutils::tkuimage::fitView .v}
...
wm title . "tkuimage viewer demo"

if {[llength $argv]} {
    ::tkutils::tkuimage::openFile .v [lindex $argv 0]
} else {
