...
package require tkutils::tkutodo
package require tclutils::tuical

wm title . "tkutodo demo"
set w [::tkutils::tkutodo::widget .t -onchange {apply {{p} {
    set open 0
    foreach c [::tkutils::tkutodo::todos $p] {
