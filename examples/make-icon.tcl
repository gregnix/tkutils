#!/usr/bin/env wish
# make-icon.tcl -- build a Windows .ico from an SVG or PNG.
#
#   wish make-icon.tcl logo.svg app.ico
#   wish make-icon.tcl logo.png app.ico 32 16
#
...
proc usage {} {
    puts stderr "usage: wish make-icon.tcl <in.svg|in.png> <out.ico> ?size ...?"
    exit 1
}
