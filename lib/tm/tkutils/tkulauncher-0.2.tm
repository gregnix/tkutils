...
# Description: an application launcher widget, as a menu or a list
# Category: Tk · widgets
#
...
proc ::tkutils::tkulauncher::widget {path args} {
    ...
    array set o [::tkutils::tkuopts::merge TKULAUNCHER [array get o] $args]
...
package provide tkutils::tkulauncher 0.2