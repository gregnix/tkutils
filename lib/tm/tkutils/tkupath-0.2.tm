...
# Description: a breadcrumb path bar with clickable segments
# Category: Tk · widgets
#
...
proc ::tkutils::tkupath::widget {path args} {
    ...
    array set o [::tkutils::tkuopts::merge TKUPATH [array get o] $args]
...
package provide tkutils::tkupath 0.2