...
# Description: a tabbed container with a "+" button and closeable tabs
# Category: Tk · widgets
#
...
proc ::tkutils::tkutab::widget {path args} {
    ...
    array set o [::tkutils::tkuopts::merge TKUTAB [array get o] $args]
...
package provide tkutils::tkutab 0.2