# tkutils::tkzip -- ZIP archive browser
#
...
proc ::tkutils::tkzip::widget {path args} {
    ...
    set state($path,zip) ""
    bind $path <Destroy> [list ::tkutils::tkzip::_cleanup $path %W]
...
proc ::tkutils::tkzip::openFile {path zipfile} {
    variable state
...
proc ::tkutils::tkzip::_populate {path} {
    variable state
    set tv $path.tv
...
package provide tkutils::tkzip 0.1
